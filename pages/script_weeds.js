// Save bid as a note
document.getElementById('weedsForm').addEventListener('submit', function(event) {
    event.preventDefault();

    // Get form values
    const bidPrefix = document.getElementById('bidPrefix').value;
    const wlength = document.getElementById('wlength').value;
    const wwidth = document.getElementById('wwidth').value;
    const wtall = document.getElementById('wtall').value;
    const location = document.getElementById('location').value;
    const brushhog = document.getElementById('brushhog').value;
    const debris = document.getElementById('debris').value;
    const menW = document.getElementById('menW').value;
    const hrsW = document.getElementById('hrsW').value;
    ...
    const bidText = `${bidPrefix} Need to remove approx ${wlength} x ${wwidth} = ${wlength*wwidth} SF of weeds/overgrowth - ${wtall}ft tall from ${location} side of the property. Will generate approx ${debris} cyds of debris - includes hauling away. Brush hog needed: ${brushhog}. Will require ${menW} men and ${hrsW} hours to complete the task. ${equipments}. ${conj ? `***Must be approved in conjunction to ${conj} bid.` : ''} ${additionalInfo}\nPrice: $${formattedPrice}`;
