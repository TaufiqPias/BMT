...
document.getElementById('LCForm').addEventListener('submit', function(event) {
    ...
    const bidText = `${bidPrefix} Need to replace ${lccount} ${lctype} coded to ${lcode}. Location: ${location}. Reason: ${reason} ${conj ? `***Must be approved in conjunction to ${conj} bid.***` : ''} ${additionalInfo}\nPrice: $${formattedPrice}`;
