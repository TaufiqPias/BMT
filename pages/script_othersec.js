// Save bid as a note
document.getElementById('OLForm').addEventListener('submit', function(event) {
    ...
    const bidText = `${bidPrefix}Need to replace ${lccount} ${lctype} to the property to secure the property completely and prevent trespassing. Reason: ${reason} ${conj ? `***Must be approved in conjunction to ${conj} bid.***` : ''} ${additionalInfo}\nPrice: $${formattedPrice}`;
