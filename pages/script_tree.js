...
document.getElementById('treeForm').addEventListener('submit', function(event) {
    ...
    const treeaction = document.getElementById('treeaction').value;
    ...
    const bidText = `${bidPrefix} Need to ${treeaction} ${treeCount} ${treeSize} trees at the ${location} of the property due to ${reason}. Will generate approx ${debris} cyds of debris.${grinder} Will require ${equipments}. ${conj ? `***Must be approved in conjunction to ${conj} bid.` : ''} ${additionalInfo}\nPrice: $${formattedPrice}`;
