// Save bid as a note
document.getElementById('vinesForm').addEventListener('submit', function(event) {
    event.preventDefault();

    // Get form values
    const bidPrefix = document.getElementById('bidPrefix').value;
    const vinestype = document.getElementById('vinestype').value;
    ...
    const bidText = `${bidPrefix} Need to remove approx ${vSize}LF/SF ${vinestype} vines from ${location} side of the property to prevent damage to the property. Will generate approx ${debris} cyds of debris - includes hauling away. Will require ${equipments}. ${conj ? `***Must be approved in conjunction to ${conj} bid.` : ''} ${additionalInfo}\nPrice: $${formattedPrice}`;
